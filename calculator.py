...
cal = Tk()
cal.title("Jayson's Calculator")       # name the app, i choose a "Calculator" because it's random
operator = ""
text_Input = StringVar()

txtDisplay = Entry(cal,font=('sans-sariff', 20,'bold'), textvariable=text_Input, bd=30, insertwidth=6,
